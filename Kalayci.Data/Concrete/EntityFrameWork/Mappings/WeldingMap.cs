...
{
    public class WeldingMap : IEntityTypeConfiguration<Welding>
    {
        public void Configure(EntityTypeBuilder<Welding> builder)
        {
            ...
            builder.Property(r => r.SpoolWeldingType).IsRequired(true);
